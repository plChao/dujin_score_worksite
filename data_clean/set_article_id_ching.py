...
df_clean_2['seg'] = df_clean_2['A 基礎道學'] + ',' + df_clean_2['B 啟蒙文學'] + ','  + df_clean_2['C 古文詩詞選'] + ',' + df_clean_2['D 三教經典']+ ','  + df_clean_2['E 白陽經典']+ ','  + df_clean_2['F 仙佛聖訓']+ ','  + df_clean_2['G 仙佛聖訓']+ ','  + df_clean_2['G 仙佛聖訓']
